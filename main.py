...
def attack(char_name: str, char_class: str) -> str:
    """Рассчитывает урон атаки в зависимости от класса персонажа."""
...
def defence(char_name: str, char_class: str) -> str:
    """Рассчитывает значение защиты в зависимости от класса персонажа."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Начинает сессию тренировок для выбранного класса персонажа."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Предлагает пользователю выбрать класс персонажа."""
    approve_choice: str = ''
    char_class: str = ''
